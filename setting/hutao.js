...
const owned = "6287875411618@s.whatsapp.net"
let awal = `
Hay ${pushname}!👋 ${ucapan()}
*HutaoMd* adalah bot untuk membantu kebutuhan sehari-hari dan mempermudah pekerjaan anda di WhatsApp yang siap melayani anda 24jam
⛩️ *U S E R I N F O* ⛩️
╭──────────────────────
│ _Name_ : *${pushname}*
...
┖─╌─╌────╌〣
_ヌル Caywzz_`,
                      hasMediaAttachment: true, ...(await prepareWAMessageMedia({ image: { url: 'https://files.catbox.moe/rd1fp8.jpg' }}, { upload: cay.waUploadToServer }))
                    }),
                    nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.fromObject({
                      buttons: [
                        {
"name": "single_select",
"buttonParamsJson": `{ "title": "ꜱᴇʟᴇᴄᴛ ᴀ ᴍᴇɴᴜ!", "sections": [{ "title": "# ꜱɪʟᴀʜᴋᴀɴ ᴘɪʟɪʜ ꜱᴀʟᴀʜ ꜱᴀᴛᴜ ᴅɪ ʙᴀᴡᴀʜ ɪɴɪ", "highlight_label": \"Powered By Cay\", "rows": [{ "header": "AllMenu", "title": "くそ ᴍᴇɴᴜᴀʟʟ", "id": ".menuall" }, 
{ "header": "Menux", "title": "くそ ᴍᴇɴᴜx", "id": ".menux" }, 
{ "header": "AiMenu", "title": "くそ ᴀɪᴍᴇɴᴜ", "id": ".aimenu" }, 
{ "header": "BugMenu", "title": "くそ ʙᴜɢᴍᴇɴᴜ", "id": ".bugmenu" }, 
{ "header": "OwnerMenu", "title": "くそ ᴏᴡɴᴇʀᴍᴇɴᴜ", "id": ".ownermenu" }, 
{ "header": "GroupMenu", "title": "くそ ɢʀᴏᴜᴘᴍᴇɴᴜ", "id": ".groupmenu" }, 
{ "header": "SearchMenu", "title": "くそ ꜱᴇᴀʀᴄʜᴍᴇɴᴜ", "id": ".searchmenu" }, 
{ "header": "DownloadMenu", "title": " くそ ᴅᴏᴡɴʟᴏᴀᴅᴍᴇɴᴜ", "id": ".downloadmenu" }, 
{ "header": "DdosMenu", "title": "くそ ᴅᴅᴏꜱ ᴍᴇɴᴜ", "id": ".ddosmenu" }, 
{ "header": "VpsMenu", "title": "くそ ᴠᴘꜱᴍᴇɴᴜ", "id": ".vpsmenu" }, 
{ "header": "DigitalOceanMenu", "title": "くそ ᴅɪɢɪᴛᴀʟᴏᴄᴇᴀɴᴍᴇɴᴜ", "id": ".digitaloceanmenu" }]}]}`
},
                      {
                        "name": "cta_url",
...
┗──≫`
      ...
      } freya = fs.readFileSync('./image/music.mp3')
        cay.sendMessage(m.chat, { audio: freya, mimetype: 'audio/mpeg', ptt: true }, { quoted: m })
        break
 case "menujava": {
        const text12 = `
